...
// 获取银行列表
export const getBanks = params => { return instance.get(`${sh_url}/backend/withdraws/back/list`,params).then(res => res.data) };
//编辑法人信息
export const EditLegalPersonInfo = params => { return instance.post(`${sh_url}/backend/withdraws/edit/business`, qs.stringify(params)).then(res => res.data) };
//获取法人信息
export const GetLegalPersonInfo = params => { return instance.get(`${sh_url}/backend/withdraws/business`, params).then(res => res.data) };
...
//获取一级科目列表
export const FirstTagList = params => {
  //console.log(params)
  return instance.get(`${fz_url}/backend/first/code`, 
  params).
  then(res => res.data)
 };
//获取二级科目列表
export const SecondTagList = params => { return instance.get(`${fz_url}/backend/second/code`, params).then(res => res.data) };
//获取三级科目列表
export const ThirdTagList = params => { return instance.get(`${fz_url}/backend/third/code`, params).then(res => res.data) };
//分账规则新增
...
//获取对私订单列表
export const privateList= params => { 
  return instance.get(`${fz_url}/backend/private/list`,params).then(res => res.data) };
//获取对用对私订单对应的分配记录
